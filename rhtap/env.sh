...
export IMAGE_URL=${IMAGE_URL-quay.io/quay_xjiang/testgo0122aa:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/xjiangorg/testgo0122aa-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.rosa.xjiang0117a.ti4k.p3.openshiftapps.com}
